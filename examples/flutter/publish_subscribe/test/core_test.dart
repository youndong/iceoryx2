...
Future<void> testBasicFFI() async {
  ...
  try {
    ...
    final nodeBuilderNewFunc =
        lib.lookup<NativeFunction<Pointer<Void> Function()>>(
            'iox2_node_builder_new');
    final nodeBuilderNew =
        nodeBuilderNewFunc.asFunction<Pointer<Void> Function()>();
...
Future<void> testNodeCreation() async {
  ...
  try {
    ...
    final nodeBuilderNewFunc = lib
        .lookup<
            NativeFunction<
                Pointer<Iox2NodeBuilder> Function(
                    Pointer<Void>)>>('iox2_node_builder_new')
        .asFunction<Pointer<Iox2NodeBuilder> Function(Pointer<Void>)>();

    final nodeBuilderCreateFunc = lib
        .lookup<
            NativeFunction<
                Int32 Function(Pointer<Iox2NodeBuilder>, Pointer<Void>, Int32,
                    Pointer<Pointer<Iox2Node>>)>>('iox2_node_builder_create')
        .asFunction<
            int Function(Pointer<Iox2NodeBuilder>, Pointer<Void>, int,
                Pointer<Pointer<Iox2Node>>)>();
